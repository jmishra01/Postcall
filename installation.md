...
Open the disk image and drag Postcall into Applications. Current packages use ad-hoc signing, so macOS may require approval under **System Settings → Privacy & Security**. Public releases should be signed and notarized with an Apple Developer certificate.
...
Configure Apple and Windows code-signing credentials before distributing publicly to avoid operating-system trust warnings.
